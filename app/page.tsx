  ...
  return (
    <main>
      <header className="shell nav">
        ...
        <nav className="navlinks"><a href="#market">Market</a><a href="#impact">High Impact</a><a href="#charts">Charts</a><a href="#sectors">Sectors</a><a href="#news">News</a><a href="#pro">Pricing</a></nav>
      ...
      <section className="shell hero" id="top">
        <div><div className="eyebrow">Curated crypto intelligence</div><h1><span className="hero-main">See what matters.</span><span className="hero-sub">Before the noise.</span></h1><p>Market-moving crypto news, high-impact events, and sector rotation — filtered down to what a trader actually needs to know.</p><div className="actions"><a className="btn primary" href="#market">Explore REVEDGE</a><a className="btn" href="#pro">Go Pro</a></div></div><MarketNow />
      </section>
