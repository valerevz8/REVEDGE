  ...
  return (
    <main>
      <header className="shell nav">
        ...
        <div className="navright"><HeaderPreferences /><a className="sign re-back" href="/" aria-label="Back to REVEDGE" title="Back to REVEDGE"><svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M19 12H5"/><path d="m12 19-7-7 7-7"/></svg></a></div>
      </header>
