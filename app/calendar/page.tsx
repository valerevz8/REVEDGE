  ...
  return (
    <main>
      <header className="shell nav">
        ...
        <div className="navright"><span className="lang">EN / ID</span><a className="sign" href="/" aria-label="Back to REVEDGE" title="Back to REVEDGE" style={{display:"grid",placeItems:"center",width:36,height:36,border:"1px solid var(--line)",borderRadius:10,background:"#12120f"}}><svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M19 12H5"/><path d="m12 19-7-7 7-7"/></svg></a></div>
      </header>
